  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute top-4 right-4 rounded-md p-1 text-muted-foreground opacity-70 outline-none transition-opacity hover:opacity-100 hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring">
